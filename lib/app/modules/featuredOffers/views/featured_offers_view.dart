...
class FeaturedOffersView extends GetView<FeaturedOffersController> {
  const FeaturedOffersView({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: CustomAppBar(title: StringConstant.featuredOffers),
